...
Page({
  ...
  init: function() {
    ...
    this.animationObj1.translate3d(0,provincePos + "em",0).step({duration: 200});
    this.setData({
      animationProvinces : this.animationObj1.export(),
    }); 

    this.animationObj2.translate3d(0,cityPos + "em",0).step({duration: 200});
    this.setData({
      animationCitys : this.animationObj2.export(),
    });

    this.animationObj3.translate3d(0,areaPos + "em",0).step({duration: 200});
    this.setData({
  ...
  rollGear : function(target) {
     ...
     function setGear (target, val) {
        ...
        switch(target.dataset.type){
              case "provinces":
                  ...
                  _that.animationObj2.translate3d(0,cityVal * -2 + "em",0).step({duration: 200});
                  _that.setData({
                 ...
                 // console.log(areas);
                  ...
                  _that.animationObj3.translate3d(0,areaVal * -2 + "em",0).step({duration: 200});
                  _that.setData({
    ...
    target["int_" + target.id] = setInterval(function() {
        ...
        target["pos_" + target.id] = pos;
         ...
         if(target.dataset.type == 'provinces') {
            _that.animationObj1.translate3d(0,pos + "em",0).step({duration: 200});
            _that.setData({
              animationProvinces : _that.animationObj1.export(),
            })
        } else if(target.dataset.type == 'citys') {
             _that.animationObj2.translate3d(0,pos + "em",0).step({duration: 200});
             _that.setData({
                animationCitys : _that.animationObj2.export(),
            })
        } else if(target.dataset.type == 'areas') {
           _that.animationObj3.translate3d(0,pos + "em",0).step({duration: 200});
           _that.setData({
              animationAreas : _that.animationObj3.export(),
           })
        }   
